...
To simulate:
pixi run opentrons_simulate -L ./labware protocols/BombBio_Trizol_RNA_reuse_shake_noElute_pause.py
'''
...
metadata = {'protocolName': 'BombBio_Trizol_RNA_reuse_shake_noElute_pause','author': 'Jared Bard','source': 'Protocol Library',}

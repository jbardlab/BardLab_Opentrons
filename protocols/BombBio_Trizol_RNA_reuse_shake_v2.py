...
To simulate:
pixi run opentrons_simulate -L ./labware protocols/BombBio_Trizol_RNA_reuse_Shake_v2.py
'''
...
metadata = {'protocolName': 'BombBio-trizol-rna-reuse-Shake-v2','author': 'Jared Bard','source': 'Protocol Library',}

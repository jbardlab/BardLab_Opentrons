...
To simulate:
pixi run opentrons_simulate -L ./labware protocols/BombBio_Trizol_RNA_reuse_shake_v3.py
'''
...
metadata = {'protocolName': 'BombBio-trizol-rna-reuse-Shake-v3','author': 'Jared Bard','source': 'Protocol Library',}
...
def add_parameters(parameters):
    ...
    parameters.add_float(
        ...
        default=750,minimum=100,maximum=900,
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    p1000_flow_rate_aspirate_default = 300
    p1000_flow_rate_dispense_default = 400
    ...
    load_backup_tips(BACKUP_TIPRACKS,'tip50',protocol.load_labware(TIP50_APINAME,TIP50_DECKSLOT2,TIP50_APINAME))
